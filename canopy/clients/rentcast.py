...
RentCast was retired as the primary listings source (see docs/ARCHITECTURE.md's
Appendix) and later restored as a background-only weekly feed: it no longer
supplies rating candidates, it exists purely to keep canopy/rentcast_backfill.py's
collation data fresh (see canopy/cli.py::run_rentcast_weekly).
"""
